const translations = {
  en: {
    ...
    hero_desc: "A lightweight menu bar app that monitors live session activity for Claude Code, Codex, OpenCode, Aider, Gemini CLI, and GitHub Copilot. See what your AI assistants are doing — without switching windows.",
    ...
    feature_multi_desc: "Works with Claude Code, Codex, OpenCode, Aider, Gemini CLI, and GitHub Copilot out of the box. Monitor all your AI coding assistants from a single unified interface.",
    ...
    feature_plugin_desc: "Install, update, and manage plugins for Claude Code, OpenCode, and GitHub Copilot directly within the app. No manual configuration needed.",
    ...
    usage_step2_desc: "Open Settings and install plugins for Claude Code, OpenCode, and GitHub Copilot with one click. For Codex, Aider, and Gemini CLI, the built-in wrapper handles monitoring automatically.",
    ...
    faq_q4: "Which AI coding tools are supported?",
    faq_a4: "VibeBar supports Claude Code, Codex, OpenCode, Aider, Gemini CLI, and GitHub Copilot. The plugin architecture is designed to be extensible, so more tools may be supported in the future.",
  ...
  zh: {
    ...
    hero_desc: "一款轻量级菜单栏应用，实时监控 Claude Code、Codex、OpenCode、Aider、Gemini CLI 和 GitHub Copilot 的会话活动。无需切换窗口，即可掌握 AI 助手的工作状态。",
    hero_download: "立即下载",
    hero_source: "查看源码",
    features_title: "功能特性",
    ...
    feature_multi_desc: "开箱即用地支持 Claude Code、Codex、OpenCode、Aider、Gemini CLI 和 GitHub Copilot。通过一个统一界面监控所有 AI 编程助手。",
    ...
    feature_plugin_desc: "直接在应用内安装、更新和管理 Claude Code、OpenCode 和 GitHub Copilot 的插件，无需手动配置。",
    ...
    usage_step2_desc: "打开设置，一键安装 Claude Code、OpenCode 和 GitHub Copilot 的插件。对于 Codex、Aider 和 Gemini CLI，内置的包装器会自动处理监控。",
    ...
    faq_q4: "支持哪些 AI 编程工具？",
    faq_a4: "VibeBar 支持 Claude Code、Codex、OpenCode、Aider、Gemini CLI 和 GitHub Copilot。插件架构设计为可扩展的，未来可能支持更多工具。",
  ...
  ja: {
    ...
    hero_desc: "Claude Code、Codex、OpenCode、Aider、Gemini CLI、GitHub Copilot のセッション活動をリアルタイムで監視する軽量メニューバーアプリ。ウィンドウを切り替えることなく、AI アシスタントの状態を把握できます。",
    ...
    feature_multi_desc: "Claude Code、Codex、OpenCode、Aider、Gemini CLI、GitHub Copilot にすぐに対応。統一されたインターフェースですべての AI コーディングアシスタントを監視できます。",
    ...
    feature_plugin_desc: "アプリ内で直接 Claude Code、OpenCode、GitHub Copilot のプラグインをインストール、更新、管理。手動設定は不要です。",
    ...
    faq_q4: "どの AI コーディングツールがサポートされていますか？",
    faq_a4: "VibeBar は Claude Code、Codex、OpenCode、Aider、Gemini CLI、GitHub Copilot をサポートしています。プラグインアーキテクチャは拡張可能に設計されており、将来的により多くのツールがサポートされる可能性があります。",
  ...
  ko: {
    ...
    hero_desc: "Claude Code, Codex, OpenCode, Aider, Gemini CLI, GitHub Copilot의 세션 활동을 실시간으로 모니터링하는 경량 메뉴 바 앱. 창을 전환하지 않고도 AI 어시스턴트의 상태를 파악할 수 있습니다.",
    hero_download: "다운로드",
    hero_source: "소스 보기",
    features_title: "기능",
    ...
    feature_multi_desc: "Claude Code, Codex, OpenCode, Aider, Gemini CLI, GitHub Copilot을 기본으로 지원합니다. 통합된 인터페이스에서 모든 AI 코딩 어시스턴트를 모니터링하세요.",
    ...
    feature_plugin_desc: "앱 내에서 직접 Claude Code, OpenCode, GitHub Copilot의 플러그인을 설치, 업데이트, 관리할 수 있습니다. 수동 설정이 필요 없습니다.",
    ...
    usage_step2_desc: "설정을 열고 Claude Code, OpenCode, GitHub Copilot의 플러그인을 원클릭으로 설치하세요. Codex, Aider, Gemini CLI의 경우 내장 래퍼가 자동으로 모니터링을 처리합니다.",
    ...
    faq_q4: "어떤 AI 코딩 도구가 지원되나요?",
    faq_a4: "VibeBar는 Claude Code, Codex, OpenCode, Aider, Gemini CLI, GitHub Copilot을 지원합니다. 플러그인 아키텍처는 확장 가능하도록 설계되어 향후 더 많은 도구가 지원될 수 있습니다.",
