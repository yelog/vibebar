    ...
    public static func merge(primary: TerminalContext?, fallback: TerminalContext?) -> TerminalContext? {
        ...
        case let (primary?, fallback?):
            return TerminalContext(
                ...
                clientTabID: primary.clientTabID ?? fallback.clientTabID,
                clientNativeSessionID: primary.clientNativeSessionID ?? fallback.clientNativeSessionID,
